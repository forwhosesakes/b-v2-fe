...
import MovingStars from "../../components/moving-stars/moving-stars.tsx"
...
const Hero = () => {
  return (
    <SectionWrapper id="hero" styles="bg-landing-page-image bg-contain bg-no-repeat ">
      <div className="md:mt-36 mt-16 border flex flex-col items-center justify-center">
        <h1 className="leading-loose">بصير .. الحلول الذكية</h1>
        <h3 className="text-center text-white/60">لمجتمعات عمرانية حديثة</h3>

        <div className="relative border md:w-4/5 w-full">
