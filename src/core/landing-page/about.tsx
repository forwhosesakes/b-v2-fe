...
const About = () => {
  return (
    <SectionWrapper direction={"horzontal_to_vertical"}  id="about" styles="relative mt-16">
      ...
      <img className=" absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:w-[400px] md:h-[400px] w-[280px] h-[280px]rounded-full object-contain z-50"  src={"/b-v2-fe/src/assets/images/demo-devices.svg"}/>
