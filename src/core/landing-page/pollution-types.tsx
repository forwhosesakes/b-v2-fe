...
const PollutionTypes = () => {
  return (
    <SectionWrapper id="pollution-types" direction="vertical" styles="w-3/5">
      ...
      <img className=" absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:w-[500px] md:h-[500px] w-[360px] h-[360px] rounded-full object-cover z-10" src={PollutionTypesImage}/>
