  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'challenges-image': "url('/assets/images/challenges-bg.png') lightgray 50%",
        ...
        'card-gridlines' : "url('/assets/images/card-gridline.png')", 
        'map-circles' : "url('/assets/images/maps-circle-borders.svg')", 
        'textbox-gradient':'linear-gradient(180deg, rgba(169, 163, 194, 0.20) 0%, rgba(169, 163, 194, 0.05) 100%)',
        'union': "url('/assets/images/union.svg')",
        ...
        'detection-process':'url("/assets/images/detection-process-v2.png")', 
