import HouseIcon from "/assets/icons/house-rounded.svg"
  ...
  return (
    <div className={`absolute ${props.x} ${props.y}`}>
      <div className="relative">
        <div className="popup-info absolute inset-0 flex flex-col gap-y-2 p-5 text-[8px]">
          <p className="text-nowrap  flex w-full items-center gap-x-2 text-xs">
            <img src="/assets/icons/house-rounded.svg" />
        ...
        >
          <path
            ...
            fill={`url(#${colors[props.report.id % 3]})`}
          />
          <path
          ...
          <defs>
            ...
            >
              ...
              <stop offset="1" stop-color="#038C9F00" stop-opacity="0" />
            </linearGradient>
