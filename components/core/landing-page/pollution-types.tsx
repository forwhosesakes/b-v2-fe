  ...
  return (
    <SectionWrapper id="pollution-types" direction="vertical" styles="w-3/5">
      ...
      <div className="relative my-12 h-[380px] w-[380px] md:mx-auto md:h-[580px] md:w-[580px]">
        ...
        <div  className="absolute  left-1/2 top-1/2 z-10 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2  md:h-[480px] md:w-[480px]">
        <LazyLoadImage
         className="object-cover"
          src={'/assets/images/pollution-types.png'}
        />
        </div>
      </div>
    </SectionWrapper>
